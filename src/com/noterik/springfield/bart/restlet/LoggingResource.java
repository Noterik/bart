 ...
 * @access private
 * @version $Id: LoggingResource.java,v 1.2 2011-11-15 13:22:28 derk Exp $
 *
 */
public class LoggingResource extends ServerResource {
    ...
    public Representation doGet() {
		...
		String name = qForm.getFirstValue("name","com.noterik.springfield.bart"); // default root package
